...
- Sitemap URL count: **19 indexable content pages**
- Public directory-based HTML pages: **21 total; 19 indexable and 2 intentionally `noindex,follow` legacy city pages**
