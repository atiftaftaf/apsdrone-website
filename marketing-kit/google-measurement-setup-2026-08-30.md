...
- The current query-mapped site conversion update passed both `verify_site_integrity.js` and `verify_conversion_tracking.js`: 21 sitemap pages, 273 valid internal links, 26 parseable JSON-LD blocks and all 20 non-home measured quote-route campaigns green.
